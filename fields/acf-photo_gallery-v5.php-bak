...
class acf_field_photo_gallery extends acf_field {
	...
	*/
	...
	function render_field( $field )
	{
		...
		$acf_photo_gallery_attachments = $field['value'];
	...
	?>
		...
		<div id="acf-photo-gallery-metabox-edit">
			<?php
				if( !empty($acf_photo_gallery_attachments) and count($acf_photo_gallery_attachments) ):
			...
			?>
			<li id="acf-photo-gallery-mediabox-<?php echo $image->ID; ?>" data-id="<?php echo $image->ID; ?>">
				<a class="dashicons dashicons-edit" href="#" title="Edit" data-id="<?php echo $image->ID; ?>" data-field="<?php echo $field['_name']; ?>"></a>
				<a class="dashicons dashicons-dismiss" href="<?php echo admin_url('admin-ajax.php'); ?>?action=acf_photo_gallery_remove_photo&_wpnonce=<?php echo $nonce_acf_photo_gallery; ?>&post=<?php echo $post->ID; ?>&photo=<?php echo $image->ID; ?>&field=<?php echo $field['key']; ?>&id=<?php echo $field['id']; ?>" data-id="<?php echo $image->ID; ?>" data-field="<?php echo $field['_name']; ?>" title="Remove this photo from the gallery"></a>
				<input type="hidden" name="<?php echo $field['_name']; ?>[]" value="<?php echo $image->ID; ?>"/>
