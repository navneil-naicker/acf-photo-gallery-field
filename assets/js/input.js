(function( $ ){
	...
	function acf_photo_gallery_html( attachment, field){
		...
		$('#acf-photo-gallery-metabox-list').prepend('<li id="acf-photo-gallery-mediabox-' + id + '"><a class="dashicons dashicons-edit" href="#" title="Edit" data-id="' +  id + '"></a><a class="dashicons dashicons-dismiss" href="#" data-id="' +  id + '" title="Remove this photo from the gallery"></a><input type="hidden" name="'+ field +'[]" value="' +  id + '"/><img src="' +  url + '"/></li>');
	}
